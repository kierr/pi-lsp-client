...
import type { DiagnosticsArgs, RenderResultOptions, ResultLike } from "./shared.js";
import { COLLAPSED_HEAD, diagSeverityChar, diagSeverityKey, EXPANDED_HEAD, PATH_BUDGET, unique } from "./shared.js";
